            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead className="flex justify-center items-center">DOB</TableHead>
                  <TableHead>Contact</TableHead>
                  <TableHead>Blood Type</TableHead>
                  <TableHead>Mother Tongue</TableHead>
                  <TableHead>Emergency Contact</TableHead>
                  <TableHead className="flex justify-center items-center">Address</TableHead>
                      ...
                      <AlertDialog>
                        <AlertDialogTrigger asChild>
                          <Button
                            variant="ghost"
                            size="icon"
                            className="text-destructive hover:text-destructive hover:bg-destructive/10 disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
                          >
